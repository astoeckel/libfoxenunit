...
#define EXPECT_TRUE(is) EXPECT(1, ((is) != 0) ? 1 : 0, ==)
#define ASSERT_TRUE(is) ASSERT(1, ((is) != 0) ? 1 : 0, ==)
#define EXPECT_FALSE(is) EXPECT(0, ((is) != 0) ? 1 : 0, ==)
#define ASSERT_FALSE(is) ASSERT(0, ((is) != 0) ? 1 : 0, ==)
